package com.adithya.aaafexpensemanagerv2.reusableComponents.calculatorEditText;
...
public class CalculatorEditText extends TextInputEditText {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            allowNegativeValues = typedArray.getBoolean(R.styleable.CalculatorEditText_allowNegativeValues, true);
            typedArray.recycle();
        }
